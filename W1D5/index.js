...
console.log("Expected ouput of findLongestWord(Hami, Olana) is 5 " + myFunctionTest(5, findLongestWord(["Hami", "Olana"])))
//---question 7
...
console.log("Expected output of filterLongWords([Hami, is, beatiful]) is 'Hami, beatiful' " + 
myFunctionTest(JSON.stringify(["Hami", "beatiful"]), JSON.stringify(filterLongWords(["Hami", "is", "beatiful"], 3))));
