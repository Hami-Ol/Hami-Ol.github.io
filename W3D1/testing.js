describe("Account", function(){
    ...
    it("getNumber of Account", function(){
        assert.equal(100, new Account(100).getNumber());
    });

    it("Deposit of Account ", function(){
        acc.deposit(300);
        assert.equal(300, acc.getBalance());
        
    });

    it("getBalance of Account and withdraw ", function(){
        acc.withdraw(100);
...
describe("Saving Account ", function(){
    ...
    it("getInterest of SavingAccount", function(){
        assert.equal(5, saving.getInterest());
    });

    it("setInterest of SavingAccount", function(){
        saving.setInterest(7);
        assert.equal(7, saving.getInterest());
    });

    it("addInterest of SavingAccount", function(){
        saving.deposit(250);
        saving.addInterest();
    ...
    it("endOfMonth of SavingAccount", function(){
...
describe("Checking Account", function(){
    ...
    it("getOverdraft of CheckingAccount", function(){
        
        assert.equal(500, checking.getOverdraft());
    });

    it("setOverdraft of CheckingAccount", function(){
        checking.setOverdraft(750);
        checking.withdraw(500); 
        assert.equal(250, checking.getOverdraft());
    });

    it("endOfMonth of CheckingAccount", function(){
...
describe("Bank", function(){
    ...
    it("addAccount of Bank", function(){
               
        assert.equal(1, bank.addAccount());
    });

    it("addSavingsAccount of Bank", function(){
               
        assert.equal(2, bank.addSavingsAccount(6));
    });

    it("addCheckingAccount of Bank", function(){
               
        assert.equal(3, bank.addCheckingAccount(650));
    });
    
    it("closeAccount of Bank", function(){
